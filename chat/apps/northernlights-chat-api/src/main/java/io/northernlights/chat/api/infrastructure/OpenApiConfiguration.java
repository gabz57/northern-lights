...
import static io.northernlights.security.NorthernLightsScopes.*;
            ...
            .components(new Components()
                .addSecuritySchemes(OAUTH_2_KEY, new SecurityScheme()
                    ...
                    .flows(new OAuthFlows().clientCredentials(new OAuthFlow()
                        ...
                        .refreshUrl("")
                        .scopes(new Scopes()
                            .addString(CHATTER_READ_SELF.scope, CHATTER_READ_SELF.description)
                            .addString(CHATTER_WRITE_SELF.scope, CHATTER_WRITE_SELF.description)
                            .addString(CONVERSATION_CREATE.scope, CONVERSATION_CREATE.description)
                            .addString(CONVERSATION_READ.scope, CONVERSATION_READ.description)
                            .addString(CONVERSATION_WRITE.scope, CONVERSATION_WRITE.description)
                        )
                    ))
